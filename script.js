const CONFIG = {
  ...
  yesButton: "YES",
  noButton: "NO",
  noEscapeTexts: ["yahahhayyukk gabisa😝", "yauda deh, aku anggap YES ya! 💕"],
  confirmTitle: "YEAAAY! Kamu Beneran Mau 💗",
  confirmText: "mulai dari sekarang kamu resmi jadi my valentine",
  ...
  collageTitle: "for you, my beautiful girlfriend",
  collageSubtitle: "since you came into my life,you have made my life more colorful...i am very happy with you, thank you for making me happy. 💕",
  nextCollageButton: "Satu halaman lagi… ",
  finalTitle: "happy valentine sayangku! 💞",
  finalMessage: `makasi ya sayang udah bikin aku bahagia, seneng bisa kenal kamu sejauh ini, aku beruntung banget punya kamu
                            kamu kado terbaik yang pernah aku dapetin, , i hope we stay together forever, without breaking up, 
                            let's go through everything together, solve problems calmly, put our egos aside, n not use our egos when there are problems, bcs it is our egos that destroy relationships.
                            i am very happy with you, even though i am not the first person to make you this happy, 
                            but i am happy to see you happy with me, i still have many shortcomings, i'm not good enough to be your bf, 
                            i always repeat the same mistakes, 
                            but i will change for you, give you the best of myself, i try very hard in everything . be happy, my beloved woman happy valentine 💕`,
